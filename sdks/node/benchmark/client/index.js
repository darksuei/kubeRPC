...
const benchServer = rpc.service("benchmark-server");
...
try {
  ...
  report(
    await bench(() => benchServer.call("fib", { n: 40 })),
  ...
  report(
    await bench(() => benchServer.call("generate", { count: 5000 }), 5),
  ...
  const rpcBurst = await burstTotal(() => benchServer.call("ping"), PINGS);
